"""This file puts images into certain lists making it easier for animation."""
...
class ImageList():
    """Represents the creating of the lists of images."""

    def __init__(self, filename, width, height):
        """Initialise the filename, width and height of the wanted images."""
        self._images = []
        count = 0
    ...
    def get_images(self):
        """Allow other files to use the images."""
        return self._images
